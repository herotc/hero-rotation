...
--- ======= COMMANDS =======
  ...
  function AR.CmdHandler (Message)
    ...
    if Argument1 == "cds" then
      ...
      AR.Print("CDs are now "..(HeroRotationCharDB.Toggles[1] and "|cff00ff00enabled|r." or "|cffff0000disabled|r."));
    elseif Argument1 == "aoe" then
      ...
      AR.Print("AoE is now "..(HeroRotationCharDB.Toggles[2] and "|cff00ff00enabled|r." or "|cffff0000disabled|r."));
    elseif Argument1 == "toggle" then
      ...
      AR.Print("HeroRotation is now "..(HeroRotationCharDB.Toggles[3] and "|cff00ff00enabled|r." or "|cffff0000disabled|r."));
  ...
  SlashCmdList["HEROROTATION"] = AR.CmdHandler;
