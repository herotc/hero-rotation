...
--- ============================ CONTENT ============================
  ...
  function HR.GUI.CorePanelSettingsInit ()
    ...
    CreatePanelOption("CheckButton", CP_General, "General.AlwaysShowIcon", "Always Show Icon", "Enable if you want the HeroRotation icon to show at all times. NOTE: The HeroRotation team does not suggest using this setting.");
