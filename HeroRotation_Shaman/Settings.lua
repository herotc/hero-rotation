...
-- Elemental settings
CreatePanelOption("Dropdown", CP_Elemental, "APL.Shaman.Elemental.RotationType", {"Standard", "High Crit"}, "Rotation Type", "Select which kind of rotation you would like to use.");
