...
--- ============================ CONTENT ============================
  ...
  CreatePanelOption("Dropdown", CP_Shaman, "APL.Shaman.Elemental.ChainInMain", {"Never", "Only with Splash Data", "Always"}, "Chain Lightning in the Main Icon", "When to show Chain Lightning in the main icon or as a suggestion");
