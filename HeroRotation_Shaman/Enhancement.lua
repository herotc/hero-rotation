...
local function APL()
  ...
  if Everyone.TargetIsValid() then
    ...
    elseif S.LightningShield:IsCastable() and Player:BuffDown(S.LightningShield) and (Settings.Enhancement.PreferEarthShield and Player:BuffDown(S.EarthShield) or not Settings.Enhancement.PreferEarthShield) then
