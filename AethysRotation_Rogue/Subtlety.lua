...
local function CDs ()
  if IsInMeleeRange() then
    ...
    if S.SymbolsofDeath:IsCastable() and ((AC.CombatTime() > 10 and Player:EnergyDeficit() >= 40 - (Player:IsStealthed(true, true) and 30 or 0)) or (AC.CombatTime() < 10 and Target:Debuff(S.Nightblade))) then
