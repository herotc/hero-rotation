...
local function St()
  ...
  if Player:BuffRemains(S.StarlordBuff) < 2 and (PAPValue >= 550 and not CAIncBuffUp and Player:BuffUp(S.StarweaversWarp) or PAPValue >= 560 and Player:BuffUp(S.StarweaversWeft)) then
  ...
  VarSolarEclipseST = PAPValue < 520 and CaInc:CooldownRemains() > 5 and EnemiesCount8ySplash < 3 or Player:HasTier(31, 2)
  ...
  if Player:BuffRemains(S.StarlordBuff) < 2 and VarStarsurgeCondition1 then
  ...
  if Player:BuffRemains(S.StarlordBuff) < 2 and VarStarsurgeCondition2 then
...
local function AoE()
  ...
  if Player:BuffRemains(S.StarlordBuff) < 2 and VarStarfallCondition1 then
  ...
  if Player:BuffRemains(S.StarlordBuff) < 2 and VarStarfallCondition2 then
  ...
  if S.Starfire:IsCastable() and not Player:IsMoving() and (EnemiesCount8ySplash > (3 - (num(Player:BuffUp(S.DreamstateBuff) or T314pcLunarStack > T314pcSolarStack))) and Player:BuffUp(S.EclipseLunar) or EclipseInLunar) then
