...
local function APL()
  ...
  Execute = function()
    ...
    if S.Warbreaker:IsCastableP() and HR.CDsON() and (not S.MemoryOfLucidDreams:IsAvailable() or (Player:BuffP(S.MemoryOfLucidDreams) or S.MemoryOfLucidDreams:CooldownRemainsP() > 10)) then
