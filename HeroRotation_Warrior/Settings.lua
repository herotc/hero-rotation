...
CreatePanelOption("Dropdown", CP_Warrior, "APL.Warrior.Commons.CovenantDisplayStyle", {"Main Icon", "Suggested", "Cooldown"}, "Covenant Display Style", "Define which icon display style to use for Covenant abilities.")
