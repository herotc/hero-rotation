...
local function Precombat()
  ...
  if Everyone.TargetIsValid() then
    -- potion
    if CDsON() and I.PotionofUnbridledFury:IsReady() and Settings.Commons.Enabled.Potions then
...
local function APL()
  ...
  if Everyone.TargetIsValid() then
    ...
    -- TODO: Fix buff.deaths_due. SimC references spell ID 324165, but no buff is given in-game
    if S.Blooddrinker:IsReady() and Target:IsInRange(10) and (Player:BuffDown(S.DancingRuneWeaponBuff) and (Player:Covenant() ~= "Night Fae" or S.DeathsDue:CooldownRemains() > 10)) then
