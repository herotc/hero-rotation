...
local function Stealthed (ReturnSpellOnly, StealthSpell)
  ...
  if Player:ComboPointsDeficit() <= 1 - num(S.DeeperStratagem:IsAvailable() and (Player:BuffP(VanishBuff) or S.TheFirstDance:AzeriteEnabled() and S.DarkShadow:IsAvailable())) then
