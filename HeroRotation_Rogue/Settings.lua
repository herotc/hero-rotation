...
CreatePanelOption("CheckButton", CP_Subtlety, "APL.Rogue.Subtlety.HoldCoupForCDs", "Hold Coupe De Grace for CDs", "Choose whether to hold Coup De Grace for CDs. Turn this off to enable actively holding CDs without HR avoiding using Coup whilst CDs are ready (e.g. for Keys)")
