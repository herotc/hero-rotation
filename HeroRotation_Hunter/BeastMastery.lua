...
local function APL()
  ...
  if Everyone.TargetIsValid() then
    ...
    if I.PocketsizedComputationDevice:IsEquipped() and I.PocketsizedComputationDevice:IsReady() and S.CyclotronicBlast:IsAvailable()  and (Player:BuffDownP(S.BestialWrathBuff) or Target:TimeToDie() < 5) then
