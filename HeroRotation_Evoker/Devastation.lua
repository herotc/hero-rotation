...
local function Trinkets()
  ...
  if Settings.Commons.Enabled.Trinkets then
    ...
    if Trinket1:IsReady() and not VarTrinket1BL and (not VarTrinket1Buffs and not VarTrinket1Manual and (VarDamageTrinketPriority == 1 or Trinket2:CooldownDown() or VarTrinket2ID == I.SpymastersWeb:ID() or VarTrinket2CD == 0) and (VarNextDragonrage > 20 or not S.Dragonrage:IsAvailable() or not VarTrinket2Buffs or VarTrinket2ID == I.SpymastersWeb:ID() and (Player:BuffStack(S.SpymastersReportBuff) < 5 or FightRemains >= 130 + VarNextDragonrage)))
